    ...
    <div id="gallery" className="college-gallery">
      <div className="college-gallery__inner">
        ...
        <div className="college-gallery__video">
          <div
            className="college-gallery__video__left"
            onClick={() => setOpen(!open)}
          >
            <div className="college-gallery__video__thumbnail">
              {videos?.length && (
                <img
                  src={`https://img.youtube.com/vi/${videos[0]}/mqdefault.jpg`}
                  alt=""
                />
              )}
            </div>
            ...
            >
              <Fade in={open}>
                <div>
                  <ReactPlayer url={`https://youtu.be/${videos?.[0]}`} />
                </div>
              </Fade>
            </Modal>
          </div>
          <div
            className="college-gallery__video__right"
            onClick={() => setOpenSecondModal(!openSecondModal)}
          >
            <div className="college-gallery__video__thumbnail">
              {videos?.length && (
                <img
                  src={`https://img.youtube.com/vi/${videos[1]}/mqdefault.jpg`}
                  alt=""
                />
              )}
            </div>
            ...
            >
              <Fade in={openSecondModal}>
                <div>
                  <ReactPlayer url={`https://youtu.be/${videos?.[1]}`} />
                </div>
              </Fade>
            </Modal>
          </div>
