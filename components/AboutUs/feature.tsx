    ...
    <div className="teams-list">
      ...
      <div className="merit">
        ...
        <div className="merit__feature__inner section-wrapper">
          <div className="merti__right__inner">
            <div className="merit__feature__thumbnail">
              <img src="/end-to-end.png" alt="admiz" />
            </div>
          </div>
          <div className="merit__feature__right">
            ...
            If you are thinking of applying for study abroad in India then Admizz can be the best option for you. 
            Admizz helps you from beginning  to the end of your admission process and ensures that you get admitted in our favourite university or colleges that you choose. With Admizz by your side, you don’t have to worry about whether you will get admission to your dream college or not. You are just a few clicks away to get admission to your favorite university. 
            It also provides career opportunities of your choice after applying to the universities and being admitted to them.  
            </div>
          </div>
        </div>
        <div className="merit__feature__inner section-wrapper">
        ...
        <div className="merit__feature__inner section-wrapper">
          <div className="merti__right__inner">
            <div className="merit__feature__thumbnail">
              <img src="/be-assured.png" alt="admiz" />
            </div>
          </div>
          <div className="merit__feature__right">
            <div className="merit__title block-title">
            ...
            All your favorite universities are under one roof with detailed information such as course fee, scholarships etc. .{" "}
            </div>
          </div>
        </div>
      </div>
