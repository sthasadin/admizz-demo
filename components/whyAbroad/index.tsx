  ...
  return (
    <div className="content-wrapper">
      ...
      <div className="news-card">
        ...
        <img src="/about-india/India-new-1.png" className="news-card__image" />
        <div className="news-card__text-wrapper">
          <h2 className="news-card__title">INDIA</h2>

          <div className="news-card__details-wrapper">
            <p className="news-card__excerpt">
              Experience the hustle and bustle of a unique culture and emerging
              tech industry.
            </p>
      ...
      <div className="news-card">
        <a href="#" className="news-card__card-link" />
        <img src="/about-india/Canada-new-1.jpg" className="news-card__image" />
        <div className="news-card__text-wrapper">
      ...
      <div className="news-card">
        <a href="#" className="news-card__card-link" />
        <img src="/about-india/france-new-1.jpg" className="news-card__image" />
        <div className="news-card__text-wrapper">
