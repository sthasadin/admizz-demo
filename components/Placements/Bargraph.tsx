      ...
      <div className="bargraph__container">
        <div className="bargraph__details">
          <div className="bargraph__1">
            ...
            {graph1.size === "sm" ? (
              <SmallGraph color="#2D9CDB" />
            ) : graph1.size === "md" ? (
              <MidGraph color="#2D9CDB" />
            ) : (
              <BigGraph color="#2D9CDB" />
            )}
            {/* <svg
              width="21"
              height="81"
          ...
          <div className="bargraph__2">
            ...
            {graph2.size === "sm" ? (
              <SmallGraph color="#27AE60" />
            ) : graph2.size === "md" ? (
              <MidGraph color="#27AE60" />
            ) : (
              <BigGraph color="#27AE60" />
            )}
            {/* <svg
              width="22"
              height="131"
          ...
          <div className="bargraph__3">
            ...
            {graph3.size === "sm" ? (
              <SmallGraph color="#FFA200" />
            ) : graph3.size === "md" ? (
              <MidGraph color="#FFA200" />
            ) : (
              <BigGraph color="#FFA200" />
            )}
            {/* <svg
              width="22"
              height="149"
