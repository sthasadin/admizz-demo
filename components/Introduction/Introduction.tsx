          ...
          <div className="introduction__meta">
            <div className="introduction__meta__title">
              <span style={{ fontWeight: "bold", color: "black" }}>
                ABROAD STUDIES WITH ADMIZZ EDUCATION, INC.
              </span>
            </div>
            ...
            <div className="u-align-center-meta">
              <div className="introduction__meta__item">
                <div className="introduction__meta__item__icon">
                  ...
                  >
                    <path
                      d="M192 426.666667h640v277.333333H192z"
                      fill="#ac6e00"
                    />
                    <path
                      d="M192 704a320 128 0 1 0 640 0 320 128 0 1 0-640 0Z"
                      fill="#ac6e00"
                    />
                    <path
                      d="M492.8 174.933333L12.8 386.133333c-17.066667 8.533333-17.066667 32 0 40.533334l480 211.2c12.8 4.266667 25.6 4.266667 38.4 0L1011.2 426.666667c17.066667-8.533333 17.066667-32 0-40.533334L531.2 174.933333c-12.8-6.4-25.6-6.4-38.4 0z"
                      fill="#FFA200"
                    />
                    <path
                      d="M921.6 435.2l-426.666667-72.533333c-10.666667-2.133333-23.466667 6.4-25.6 17.066666-2.133333 10.666667 6.4 23.466667 17.066667 25.6L896 473.6V789.333333c0 12.8 8.533333 21.333333 21.333333 21.333334s21.333333-8.533333 21.333334-21.333334V456.533333c0-10.666667-8.533333-19.2-17.066667-21.333333z"
                      fill="#ac6e00"
                    />
                    <path
                      d="M917.333333 789.333333m-42.666666 0a42.666667 42.666667 0 1 0 85.333333 0 42.666667 42.666667 0 1 0-85.333333 0Z"
                      fill="#ac6e00"
                    />
                    <path
                      d="M981.333333 853.333333c0 36.266667-64 128-64 128s-64-91.733333-64-128 27.733333-64 64-64 64 27.733333 64 64z"
                      fill="#ac6e00"
                    />
                  </svg>
                </div>
