...
const AdmissionProcess = () => {
  const admission = useSelector(state => state.college.college?.addmission_process)
  {
    return (
      <div id="admission" className="admission-process">
        <div className="admission-process__inner">
          ...
          <div className="admission-process__start">
            ...
            <span> Start Date: {moment(admission?.start).format("DD MMM YYYY")} / End Date: {moment(admission?.end).format("DD MMM YYYY")}</span>
          </div>
