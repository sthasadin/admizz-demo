...
const DashboardBasicInfo = (props) => {
  ...
  const NepalState = [ "Arun", 'Janakpur', 'Kathmandu', 'Gandak', 'Kapilavastu', 'Karnali', 'Mahakali' ]
const IndianState = [ "Andhra Pradesh", "Arunachal Pradesh", "Assam", "Bihar", "Chhattisgarh", "Goa", "Gujarat", "Haryana", "Himachal Pradesh", "Jammu and Kashmir", "Jharkhand",
...
const IndiaStateOption = IndianState.map((state) => {
  ...
  }, [isPermanentAddressSame, residentialAddress, residentialCity, residentialState, residentialZipCode, residentialcountry])
          ...
          <form>
            ...
            <Grid container className="dashboard-basic-info__row" justify="space-around" direction='row' >
              ...
              <div className={'student-info__phone-separator'}>
                    <DropDownSelect options={CountryCodeOptions} title='Country Code' handelChange={setCountryCode} />
                  </div>
        ...
        <div className="dashboard-basic-info__formContainer">
          <div className="dashboard-basic-info__marginContainer">
            ...
            <form>
              <Grid container className="dashboard-basic-info__row" justify="space-around" direction='row' >
                ...
                <Grid className={'dashboard-basic-info__grid'} item sm={12} md={4} xs={12}>
                  <DropDownSelect title="Country" options={CountryOption} handelChange={setResidentialCountry} />
                </Grid>
                <Grid className={'dashboard-basic-info__grid'} item sm={12} md={4} xs={12}>
                  <DropDownSelect title="State" handelChange={setResidentialState} options={ residentialcountry==="Nepal"?NepalStateOption:IndiaStateOption}/>
                </Grid>
              </Grid>
              <Grid container className="dashboard-basic-info__row" justify="space-around" direction='row' >
                <Grid className={'dashboard-basic-info__grid'} item sm={12} md={4} xs={12}>
                ...
                <Grid container className="dashboard-basic-info__row" justify="space-around" direction='row' >
                  <Grid className={'dashboard-basic-info__grid'} item sm={12} xs={12}>
                    <FormControlLabel className="dashboard-basic-info__checkboxLabel" control={<Checkbox  onChange={() => setIsPermanentAddressSame(!isPermanentAddressSame)} value={isPermanentAddressSame}/>} label="Permanent address is same as residential address" />
                  </Grid>
                </Grid>
              </Grid>
            </form>
          ...
          <form>
            <Grid container className="dashboard-basic-info__row" justify="space-around" direction='row' >
              ...
              <Grid className={'dashboard-basic-info__grid'} item sm={12} md={4} xs={12}>
               <DropDownSelect title="Country" options={CountryOption} handelChange={setPermanentCountry} />
              </Grid>
              <Grid className={'dashboard-basic-info__grid'} item sm={12} md={4} xs={12}>
               <DropDownSelect title="State" handelChange={setPermanentState} options={ permanentcountry==="Nepal"?NepalStateOption:IndiaStateOption}/>
              </Grid>
            </Grid>
            <Grid container className="dashboard-basic-info__row" justify="space-around" direction='row' >
              <Grid className={'dashboard-basic-info__grid'} item sm={12} md={4} xs={12}>
