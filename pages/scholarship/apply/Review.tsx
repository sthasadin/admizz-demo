  ...
  return (
    <>
      ...
      >
        ...
        <Typography variant="body1">Country: {countryselected}</Typography>
        <br />
        ...
        <Divider sx={{ my: 1 }} />
        <Typography variant="body1">Parent's Name: {parentName}</Typography>
        <Typography variant="body1">Parent's Email: {parentEmail}</Typography>
        <Typography variant="body1">
        ...
        <Divider sx={{ my: 1 }} />
        <Typography variant="body1">School Marks: {schoolmarks}</Typography>
        <Typography variant="body1">
        ...
        <Typography variant="body1">GMAT: {radioGroup["GMAT"]}</Typography>
        <Typography variant="body1">SAT II: {radioGroup["SAT II"]}</Typography>
        <Typography variant="body1">TOEFL: {radioGroup["TOEFL"]}</Typography>
        <Typography variant="body1">
          JEE Advance: {radioGroup["JEE Advance"]}
        </Typography>
        <Typography variant="body1">IELTS: {radioGroup["IELTS"]}</Typography>
