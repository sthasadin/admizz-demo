  ...
  <div className="content-wrapper">
     <div className="howAhelp__content" style={{textAlign:"center",color:"#5f1802"}} >
                              <div >
                                  ...
                                  <div className="howAhelp__helpertext" style={{marginTop:"20px", marginBottom:"30px"}}>
