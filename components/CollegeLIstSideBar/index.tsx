...
const CollegeListSideBar = ({resetFilter, allCoursesWithCounts, onSelecteCourse, selectedCourses, deSelectCourse}) => {
  return (
    <div className="college-list-side-bar">
      ...
      <CollegeListSelectedFilter selectedCourses={selectedCourses} deSelectCourse={deSelectCourse} />
      <CollegeListSelectedStream allCoursesWithCounts={allCoursesWithCounts} selectedCourses={selectedCourses} onSelecteCourse={onSelecteCourse}/>
