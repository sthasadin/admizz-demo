...
const Testimonial = (props: any) => {
  ...
  const [selectedTestimonial, setselectedTestimonial] = useState({description:"",designation:"",image_url:"",name:"",video_url:"", selectedIndex:selectedIndex});
  ...
  const handleClick = (description,designation,image_url,video_url,name,index) => {
    setselectedTestimonial({description:description,designation:designation,image_url:image_url,name:name,video_url:video_url,selectedIndex:index});
    ...
    <div className="testimonial">
      ...
      <div className="testimonial__inner">
          ...
          <div className="testimonial__left">
            {
              testimonialList?.map((item, index) => {
               ...
               if( index < midepointIndex ){
                 if(index==selectedIndex){
                   return(
                    ...
                    <div className="testimonial__center__thumbnail" >
                      <img src={selectedTestimonial?.image_url} alt="testimonial" />
                    </div>
                    ...
                    >
                      <Fade in={open}>
                        <div>
                          <ReactPlayer url={selectedTestimonial?.video_url ? selectedTestimonial?.video_url: "#"} />
                        </div>
                      </Fade>
                    </Modal>
                  </div>
                 ...
                 return (
                 <div className={"testimonial__left__thumbnail"} onClick={()=>{handleClick(item.description,item.designation,item.image_url,item.video_url,item.name,index)}}  >
                 <img src={item?.image_url} style={{borderRadius:"300px"}} height="233px" width="233px" alt="testimonial1" />
                 </div>
                 )
               } } 
              })
        ...
        <div className="testimonial__author">
          <span>{selectedTestimonial?.name}</span> - {selectedTestimonial?.designation}
        </div>
      </div>
