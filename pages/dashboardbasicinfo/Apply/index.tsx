...
const DashboardBasicInfoPage = () => {
  ...
  const getStepContent = (step: number) => {
    switch (step) {
      case 0:
        return <DashboardBasicInfo handleNext={handleNext} getData = {setBasicInfo} data={basicInfo}/>;
      case 1:
        return (
      ...
      case 4:
        return <DashboardReviewConfirm handleBack={handleBack} basicInfo = {basicInfo} backgroundInfo={backgroundInfo} academicInfo={academicInfo} selectedChoice={selectedChoice}/>;
      default:
        return "Unknown step";
    }
  };
